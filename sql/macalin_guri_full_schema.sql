-- =============================================================================
-- Macalin Guri — MySQL schema (auth reference tables + app models; API: CodeIgniter 4)
...
-- Haddii miisaska `django_*` / `auth_*` hore u jiraan: ha celin qaybta soo celinta.
-- =============================================================================
...
-- ---------------------------------------------------------------------------
-- Reference: auth + content types (users_user M2M groups / permissions)
-- ---------------------------------------------------------------------------
...
-- =============================================================================
-- Dhamaad. API: CodeIgniter 4 (`backend_ci4/`). Miisaskan waa saldhigga MySQL.
-- =============================================================================
